...
double FSMC3::Utils::mapInt16ToDouble(int16_t target, int16_t fromLow, int16_t fromHigh, double toLow, double toHigh)
{
	if (target < fromLow)
	{
		return toLow;
...
int16_t FSMC3::Utils::mapDoubleToInt16(double target, double fromLow, double fromHigh, int16_t toLow, int16_t toHigh)
{
	if (target < fromLow)
	{
		return toLow;
